...
DIRECTORIES = os.listdir(r'\\fileshare\\ForTechnicalSupport\\9_QMS_CASHIN_INFOTOUCH\\QMS\\Branches')
...
d = r'\\fileshare\\ForTechnicalSupport\\9_QMS_CASHIN_INFOTOUCH\\QMS\\Branches\\{}'.format(FOLDER_NAME)
