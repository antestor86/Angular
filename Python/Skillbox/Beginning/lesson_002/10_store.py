...
table_price = table_item[0]['price'] + table_item[1]['price']
...
sofa_price = sofa_item[0]['price'] + sofa_item[1]['price']
...
chair_price = chair_item[0]['price'] + chair_item[1]['price'] + chair_item[2]['price']
